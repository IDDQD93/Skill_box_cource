async function getCurrentWeatherByCity(city) {
    const data = await fetch(`http://api.weatherapi.com/v1/current.json?key=cfa4ffcffaa14d389fe133134240311&q=${city}&aqi=no`) 
...
async function getForecastByCity(city) {
    const data = await fetch(`http://api.weatherapi.com/v1/forecast.json?key=cfa4ffcffaa14d389fe133134240311&q=${city}&days=1&aqi=no&alerts=no`) 
